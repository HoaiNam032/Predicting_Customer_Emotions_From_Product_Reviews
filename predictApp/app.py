...
st.markdown("""
- 🤖 **Logistic Regression (Machine Learning truyền thống)**: Mô hình đơn giản nhưng hiệu quả, đạt **93% độ chính xác**.
- 📦 **Dữ liệu thực tế từ Tiki**: Bình luận sản phẩm tiếng Việt được crawl và xử lý.
- 🧹 **Tiền xử lý văn bản tiếng Việt**: Chuẩn hóa; tách từ; xử lý từ cấm,từ viết tắt...
- 🌐 **Streamlit**: Giao diện người dùng đơn giản, thân thiện, trực quan.
""")

st.markdown("### 🔗 Liên kết")
st.markdown("""
- 📂 **Mã nguồn**: [GitHub Repository](https://github.com/HoaiNam032/Predicting-Customer-Emotions-From-Product-Reviews)
- 📅 **Phiên bản**: 1.0 | 🕓 Ngày tạo: Tháng 9/2025
""")
